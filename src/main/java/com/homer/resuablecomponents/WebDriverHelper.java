...
public class WebDriverHelper {
	...
	public void selectByVisibleText(String option,By elementBy) throws Exception{            
	       
        
        Select select = new Select(driver.findElement(elementBy));
                 List<WebElement> selectOptions = select.getOptions();
                 System.out.println("Size is "+ selectOptions.size());
                 try{
...
//	public void isenable(String details) throws Exception{
//		  
//		WebElement ele = null;
//		WebDriverWait wait = new WebDriverWait(driver, 10);
//	    ele = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(details)));
//		
//		
//	}
